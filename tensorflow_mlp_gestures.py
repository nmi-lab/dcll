...
layers[0], states[0], output0 = DCNNDenseLayer(feat_out=Nfeat1, input_shape = Nin     , layer_input = None   , batch_size=batch_size, target_size = Nout)
layers[1], states[1], output1 = DCNNDenseLayer(feat_out=Nfeat2, input_shape = [Nfeat1], layer_input = output0, batch_size=batch_size, target_size = Nout)
layers[2], states[2], output2 = DCNNDenseLayer(feat_out=Nfeat3, input_shape = [Nfeat2], layer_input = output1, batch_size=batch_size, target_size = Nout)
...
if __name__ == '__main__':
    ...
    gen_train, gen_test = create_data(batch_size=batch_size, small=False)
