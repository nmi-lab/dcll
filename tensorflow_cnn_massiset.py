...
if __name__ == '__main__':
    ...
    gen_inputs_test, gen_targets_test = np.random.uniform(size=[batch_size,T,300*300]), np.zeros([T,batch_size,11],dtype='int')
    for i in range(nepochs):
        gen_inputs, gen_targets = np.random.uniform(size=[batch_size,T,300*300]), np.zeros([T,batch_size,11],dtype='int')
